...
library(stringr)
colnames(exData3)
str_locate(colnames(exData3),"USD/")
repnames <- str_sub(colnames(exData3),1,2)
repnames
exData3 -> exData4
str_locate(repnames,"英鎊")
colnames(exData4[4]) <- str_sub(repnames[4]) 
colnames(exData4[10]) <- str_sub(repnames[10]) 
colnames(exData4[15]) <- str_sub(repnames[15]) 
colnames(exData4)[c(4,10,15)] <-str_sub(repnames[c(4,10,15)])
colnames(exData4)
exData4
```
